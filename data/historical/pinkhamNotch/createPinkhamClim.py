...
dataPath = 'data/historical/pinkhamNotch/pinkham1930_{}_rawData.csv'.format(lastYearInClimData)
...
np.save('data/historical/pinkhamNotch/pinkhamSnowpackClim1930-{}_snowDepth_cm.npy'.format(lastYearInClimData),pinkhamSnowpackClim_incm)
np.save('data/historical/pinkhamNotch/pinkhamSnowpackClim1930-{}_endWinterYears_cm.npy'.format(lastYearInClimData),np.arange(1930,lastYearInClimData+1))
